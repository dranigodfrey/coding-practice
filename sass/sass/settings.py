...
SECRET_KEY = 'django-insecure-1!lsyt6r(2ylk-8@7&na!=4@%ktxp^s@o-!qp=sr@_t-kc&%on'
...
MIDDLEWARE = [
    ...
    'tenant.middlwares.RequestIDTenantMiddleware',
...
PUBLIC_SCHEMA_URLCONF = 'sass.urls_public'
